...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 md:w-72 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full py-4 overflow-y-auto bg-gray-950 dark:bg-gray-800 tracking-wider">
      <div class="flex justify-start items-center gap-2 px-3 md:px-5 my-3"> 
            ...
            <a href="/promoter/dashboard" class="text-gray-300 font-bold ">CruiseHq</a>
      </div>   
      <ul class="space-y-2 font-medium md:mt-10 md:mb-3">
         <li>
            <a href="/promoter/dashboard" class="flex items-center w-full py-2 text-base text-gray-100 transition duration-75 px-3 md:px-5 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700">
         ...
         <li>
            <a href="/promoter/dashboard/profile" class="flex items-center w-full py-2 text-base text-gray-100 transition duration-75 px-3 md:px-5 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700">
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2 md:pl-10">
                  <li>
                     <a href="/promoter/dashboard/tickets" class="flex items-center w-full p-2 text-gray-200 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700">All tickets</a>
                  </li>
                  <li>
                     <a href="/promoter/dashboard/tickets/create" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Create ticket</a>
                  </li>
                  <li>
         ...
         <li>
            <button type="button" class="flex items-center w-full py-2 text-base text-gray-200 transition duration-75 px-3 md:px-5 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="event-toggle">
            ...
            <ul id="event-toggle" class="hidden py-2 space-y-2">
                  <li>
                     <a href="{{ route('promoter.event.index') }}" class="flex items-center w-full p-2 text-gray-200 transition duration-75 pl-11 md:pl-12 md:ml-3 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700 text-sm" class="{{ Request::routeIs('promoter.event.index') ? 'bg-gray-100 text-gray-950' : '' }}">All events</a>
                  </li>
                  <li>
                     <a href="{{ route('promoter.event.create') }}" class="flex items-center w-full p-2 text-gray-200 transition duration-75 pl-11 md:pl-12 md:ml-3 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700 text-sm">Create event</a>
                  </li>
            </ul>
         </li>
         <li>
