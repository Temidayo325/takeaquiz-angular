...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar" x-data='{user: {},
   ...
   <div class="h-full py-4 overflow-y-auto bg-white text-purple-1000 dark:bg-gray-800 tracking-wider bg-sidebar bg-cover bg-no-repeat bg-blend-multiply">
      ...
      <ul class="space-y-2 px-5 font-medium mt-12 md:mt-10 md:mb-3 text-purple-1000">
         <li>
            <a href="/user/dashboard" class="flex items-center w-full py-2 text-base text-purple-1000 transition duration-75 px-3 md:px-5 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700">
               <svg class="w-5 h-5 text-purple-1000 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
         ...
         <li>
            <a href="/user/dashboard/profile" class="flex items-center w-full py-2 text-base text-purple-1000 transition duration-75 px-3 md:px-5 group md:hover:bg-gray-100 md:hover:text-gray-950 dark:text-white dark:hover:bg-gray-700">
         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-purple-1000 transition duration-75 px-3 md:px-5 group md:hover:bg-gray-100 md:hover:text-gray-950 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2 md:pl-10">
                  <li>
                     <a href="/user/dashboard/tickets" class="flex items-center w-full p-2 text-purple-1000 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700">All ticket</a>
                  </li>
                  <li>
                     <a href="/user/dashboard/tickets/upcoming" class="flex items-center w-full p-2 text-purple-1000 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700">Upcoming tickets</a>
                  </li>
            </ul>
         </li>
         <li>
            <a href="/user/dashboard/events" class="flex justify-start w-full py-2 px-3 md:px-5 text-purple-1000 transition duration-75 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700 text-sm">
         ...
         <li>
            <a href="/user/dashboard/games" class="flex justify-start w-full py-2 px-3 md:px-5 text-purple-1000 transition duration-75 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700 text-sm">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Game inspiration</span>
            </a>
         </li>
         <li>
            <a href="/logout" class="flex justify-start w-full py-2 px-3 md:px-5 text-purple-1000 transition duration-75 group hover:bg-gray-100 hover:text-gray-950 dark:text-white dark:hover:bg-gray-700 text-sm">
