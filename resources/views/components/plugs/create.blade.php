...
<section class="py-4 text-purple-1000 " x-data='{user: @json($user), 
	...
	<form action="/plugs"
		...
		<template x-if="plug == null">
			...
			<button class="px-5 py-3 bg-red-1000 border-none text-gray-200 mt-4 rounded-lg md:shadow-sm disabled:bg-gray-400 disabled:text-purple-1000 disabled:shadow-none md:px-10 md:mt-8 hover:shadow-md shadow-sm hover:bg-red-800 hover:text-purple-200" type="submit" :disabled="plug != null">
				Create plug profile
			</button>
		</template>
	...
	<p 	class="underline underline-offset-2 text-right mt-10 md:text-left" 
			...
			<div id="default-styled-tab-content">
			    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 tracking-wider overflow-x-scroll" id="styled-profile" role="tabpanel" aria-labelledby="profile-tab">
            		<form 	action="" 
						...
						<button class="px-5 py-3 bg-red-1000 border-none text-gray-200 mt-4 rounded-lg md:shadow-sm disabled:bg-gray-400 disabled:text-purple-1000 disabled:shadow-none md:px-10 md:mt-8 hover:shadow-md shadow-sm hover:bg-red-800 hover:text-purple-200" 
