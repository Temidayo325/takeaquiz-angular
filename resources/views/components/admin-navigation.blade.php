<ul class="space-y-2 font-medium md:pb-12">
  ...
  {{--  <li>
   ...
   <li>
      <a href="/admin/dashboard/games" class="flex items-center w-full py-2 text-base transition duration-75 px-3 md:px-6 group text-purple-200 hover:bg-purple-200 hover:text-purple-1000  dark:text-white dark:hover:bg-gray-700" class="{{ Request::routeIs('admin.games.index') ? 'bg-purple-200 text-purple-1000' : '' }}">
         ...
         <span class="ms-3">Games management</span>
      </a>
   </li>
   <li>
      <button type="button" class="flex items-center w-full py-2 text-base text-purple-200 transition duration-75 px-3 md:px-5 group hover:bg-purple-200 hover:text-purple-1000 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="toggle-admin-user-ul">
   ...
   <li>
      <button type="button" class="flex items-center w-full py-2 text-base text-purple-200 transition duration-75 px-3 md:px-5 group hover:bg-purple-200 hover:text-purple-1000 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="toggle-admin-ticket-ul">
