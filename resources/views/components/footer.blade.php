	...
	<div class="grid gap-4 md:grid-cols-3">
		<div>
			...
			<p class="my-2 flex justify-start items-center gap-3">
				...
				<a href="tel:+2347015886348" class="text-sm ">07015886348</a>
			</p>
			<p class="my-2 flex justify-start items-center gap-2">
				...
				<a href="mailto:pacytcg@gmail.com" class="text-sm ">pacytcg@gmail.com</a>
			</p>
		</div>
		<div>
