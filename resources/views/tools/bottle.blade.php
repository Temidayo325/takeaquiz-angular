...
@section('content')
	...
	<div x-data="bottle" class="flex flex-col items-center justify-center md:w-4/6 shadow-md border border-gray-200 md:mx-auto my-6 bg-white text-purple-1000 py-10">
    <!-- Bottle and Spinner -->
    <div class="relative w-3/4 h-auto rounded-full border border-gray-900 shadow-md ">
        <!-- Bottle Image -->
        <div 
            class="w-32 h-48 bg-center bg-cover rounded-full "
            x-ref="bottle"
