...
@section('content')
	<div 	class="text-purple-1000 pb-32 px-4 md:px-10 md:mx-auto min-h-screen font-body" 
		...
		<div class="text-sm text-purple-1000 w-full text-left rtl:text-right dark:text-gray-400 mt-6 md:mt-8">
			<ul class="grid gap-10 md:grid-cols-4 md:gap-12">
				<template x-for="event in events.data" :key="event.id">
					<li class="hover:shadow-2xl duration-700 hover:border hover:border-gray-400 p-3 bg-gray-100 md:bg-white md:border md:border-gray-200 shadow-md md:shadow-sm relative " >
						...
						<div class="mt-3 w-full" x-show="event.tickets.length == 0">
		            		<a href="/promoter/dashboard/tickets/create" class="text-red-1000 font-bold py-2 text-center underline block underline-offset-4">Create tickets</a>
		            	</div>
		                <div class="mt-3 w-full">
		            		<a href="/promoter/dashboard/tickets" class="font-bold py-2 text-center underline block underline-offset-4">Manage tickets</a>
		            	</div>
					</li>
				</template>
			</ul>
